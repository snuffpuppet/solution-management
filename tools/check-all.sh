...
echo "== em dash scan"
if grep -l -- '—' solution-register-model.md solution-register-runner.md transcript-runner.md README.md ARCHITECTURE.md CLAUDE.md LOG.md ENHANCEMENTS.md .claude/skills/*/SKILL.md 2>/dev/null; then echo "FAIL em dash found"; fail=1; else echo "ok   no em dashes"; fi
echo "== skills"
