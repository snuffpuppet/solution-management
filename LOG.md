...
| 2026-09-09 | (this) | change | README 1.3: quickstart gains the register runner half: launch instruction, phase table, and how current, need and legacy claims become PRC, REQ or nothing. | User: quickstart did not mention creating requirements, decisions and existing processes. |
