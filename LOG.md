...
| 2026-09-09 | (this) | decision | ARCHITECTURE 1.4: P12, fewer questions over time, never at the cost of quality. Overturn rate outranks question count; findings are human-approved document edits; checkpoints unchanged. Compliance check: PROCEED, no violations. E10 now implements P12. | Owner: reduce human in the loop only where the outcome improves, quality first. |
