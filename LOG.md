...
| 2026-09-09 | (this) | change | ENHANCEMENTS E10: learning loop that reduces questions over time, a candidate principle pending an ARCHITECTURE check. | User proposed reducing the human in the loop via a self-improvement stage; recorded, not applied. |
