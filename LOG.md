...
| 2026-09-09 | (this) | change | Audit rows carry a Runner column: the transcript runner document version that ran the stage. Runner 1.3, report groups by model, mode and runner, fixture and tests updated, check gains an assertion, ARCHITECTURE 1.5 D6. Compliance check: PROCEED. | P12 needs overturn rates comparable before and after a document edit. |
