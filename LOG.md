...
| 2026-09-09 | (this) | change | ENHANCEMENTS E11: runner version on each claim record, deferred until the first data-driven guide edit. | Kept off the P7 interface until needed. |
