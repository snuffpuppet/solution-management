...
| 2026-09-09 | (this commit) | decision | Handover is user-controlled: a `/handover` skill and on-demand check, not a Stop hook. Hook stays available per user in settings.local.json. | Owner: the user keeps control of when to hand over. |
